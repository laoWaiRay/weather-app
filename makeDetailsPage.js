...
const makeDetailsPage = (cityWeatherData, hourlyWeatherData) => {
  ...
  if (unitsManager.getUnits() === 'Fahrenheit') headerTemp.innerText = `${conversion.KtoF(cityWeatherData.main.temp)}°F`;
  ...
  if (unitsManager.getUnits() === 'Fahrenheit') tempHigh.innerText = `H: ${conversion.KtoF(cityWeatherData.main.temp_max)}°F`;
  ...
  if (unitsManager.getUnits() === 'Fahrenheit') tempLow.innerText = `L: ${conversion.KtoF(cityWeatherData.main.temp_min)}°F`;
  ...
  if (unitsManager.getUnits() === 'Fahrenheit') feelsLike.innerText = conversion.KtoF(cityWeatherData.main.feels_like);
  ...
  hourlyWeatherData.forEach((weatherObj) => {
    ...
    if (unitsManager.getUnits() === 'Fahrenheit') hourlyForecastTemp.append(`${conversion.KtoF(tempInKelvin)}°F`);
